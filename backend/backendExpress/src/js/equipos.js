            ...
            col.innerHTML = `
                <div class="card h-100 equipo-card">
                    <div class="card-body d-flex flex-column">
                        ...
                        <p class="card-text text-muted mb-3">Formato: ${eq.format || "Sin formato"}</p>
                        ...
                        <div class="mt-auto d-flex gap-2">
                            ...
                            <button class="btn btn-outline-danger btn-borrar" data-id="${eq.id}">🗑</button>
                        </div>
                    </div>
                </div>`;
        ...
        res.data.forEach(p => {
            ...
            col.innerHTML = `
                <div class="card p-2 text-center equipo-pokemon-card">
                    ...
                    <button class="btn btn-sm btn-outline-danger btn-quitar" data-id="${p.id}">Quitar</button>
                </div>`;
